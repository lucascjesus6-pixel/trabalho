...
function generateResponse(text){
  ...
  if(lower.includes("socorro") || lower.includes("agressão") || lower.includes("violência")){
    response = "Sinto muito que esteja passando por isso 😢. Aqui estão delegacias próximas e seus contatos:";
  } else if(lower.includes("delegacia") || lower.includes("ajuda")){
    response = "Você pode procurar qualquer delegacia da mulher próxima. Veja no mapa acima ou na lista.";
